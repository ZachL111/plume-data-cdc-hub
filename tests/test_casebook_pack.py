"""Regression checks for the plume-data-cdc-hub casebook."""
...
from casebook.harness import assert_expected, plume_data_cdc_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_data_cdc_hub_summary(), assert_expected())
